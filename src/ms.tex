...
\def\timeInferYB{about 5 seconds\xspace}
...
%
Fourth, and finally, most Doppler imaging codes are not open source \citep[][to name a few]{Collier1997,Hackman2001,Carroll2012,Rosen2015,AsensioRamos2021},
% DOTS, INVERS7-PD, iMAP, INVERSLSD, ??
nor are the data used to produce many of the maps found in the literature, making it difficult to reproduce results and compare Doppler images of different stars on the same footing.
