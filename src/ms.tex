...
\begin{figure}[p!]
    \begin{centering}
        \includegraphics[width=0.8\linewidth]{figures/luhman16b_spectra.pdf} % 
        \caption{%
...
\xxx{%
    \begin{enumerate}
        ...
        \item%
              ...
              In a more realistic scenario, we'd know a lot more information about the spectrum---such as where the lines are and some estimate of their shapes and depths---so the fidelity of our maps would be higher. This is what we did in the Luhman 16B case, and it works well.
              %
        \item%
              ...
              %
        \item%
              We are always integrating over the entire disk of the star. Can integrate over the unocculted
              disk during an occultation (should actually be pretty trivial) so this can be used for Doppler
              tomography once I have some time to work it out!
        \item%
        ...
        \item% 
              ...
              %
        \item Discuss the case where the inclination/period/velocity is unknown, such as the case 
              with Luhman 16B.
        ...
        \item%
              Luhman 16B: we didn't account for finite exposure time. We didn't properly model instrumental broadening. We didn't do MCMC. We didn't vary the inclination. We didn't use maximum entropy regularization. But we solved for a whopping 4,000 parameters in under 3 minutes. We used the full spectrum.
    \end{enumerate}
}
