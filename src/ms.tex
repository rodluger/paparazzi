...
\xxx{%
    \begin{enumerate}
        ...
        \item \citet{Crossfield2014b} and \citet{Snellen2014}: people talk seriously about making Doppler Imaging maps of directly-imaged planets like beta Pic b with the ELTs.  
        Those will be tough measurements but could be the first real, global​ maps of any planet beyond the solar system (sorry, but eclipse-mapping just doesn't quite cut it so far...).  
        So we need the best possible algorithms to maximize what we get our of the data.
