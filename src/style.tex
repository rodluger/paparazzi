...
\usepackage{newfloat}
\usepackage{etoolbox}
\let\singlespace\undefined
\let\doublespace\undefined
\usepackage{setspace}
...
\algnewcommand\algorithmicfunction{\texttt{\textbf{function}}}
\makeatletter
\algdef{SE}[FUNCTION]{FUNCTION}{ENDFUNCTION}%
   [2][default]{\algorithmicfunction\ \texttt{\textbf{#2}}\ \ALG@compatcomm{#1}}%
   {\algorithmicend\ \algorithmicfunction}%
\newcommand{\RETURN}[1]{\STATE \texttt{\textbf{return}}\ #1}
\makeatother
