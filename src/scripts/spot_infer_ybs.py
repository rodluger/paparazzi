...
fig.savefig(
    paths.figures / "spot_infer_ybs_maps.pdf", bbox_inches="tight", dpi=150
)
...
fig.savefig(
    paths.figures / "spot_infer_ybs_spectra.pdf", bbox_inches="tight", dpi=300
)
...
fig.savefig(
    paths.figures / "spot_infer_ybs_timeseries.pdf",
    bbox_inches="tight",
    dpi=300,
)
