...
fig.savefig(
    paths.figures / "spot_infer_yb_maps.pdf", bbox_inches="tight", dpi=150
)

# Plot the timeseries
fig = plot_timeseries(
    data, y_inferred, spectrum_true, normalized=True, overlap=5
)
fig.savefig(
    paths.figures / "spot_infer_yb_timeseries.pdf",
    bbox_inches="tight",
    dpi=300,
)
