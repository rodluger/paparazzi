...
\begin{figure}[p!]
    \begin{centering}
    \includegraphics[width=0.49\linewidth]{figures/learn_map_high_snr_timeseries.pdf}
    \includegraphics[width=0.49\linewidth]{figures/learn_map_high_snr_rect.pdf}
    \oscaption{vogtstar}{%
        Solution to the \vogtstar problem at high SNR when both the rest frame spectrum
        and the baseline are known.
        \label{fig:vogtstar_learn_map_high_snr}
    }
    \end{centering}
\end{figure}
...
\begin{figure}[h!]
    \begin{centering}
    \includegraphics[width=0.95\linewidth]{figures/inclinations.pdf}
