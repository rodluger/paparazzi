...
on the surface of the star is a linear combination of $P$
...
\begin{figure}[t!]
    ...
    \oscaption{twospec}{%
        Learning two spectra simultaneously.
        \label{fig:twospec}
    }
    \end{centering}
\end{figure}
...
\begin{center}
    ...
    \midrule
    %
    $K$                      & \# of wavelength bins in the observed spectrum        & \\
    $K'$                     & \# of wavelength bins in the latent spectrum          & \\
    $M$                      & \# of epochs observed                                 & \\
    $N$                      & \# of spherical harmonic coefficients                 & \\
    $N'$                     & \# of spherical harmonic coefficients after limb darkening            & \\
    $W$                      & \# of wavelength bins in the convolution kernel       & \\
    %
    \midrule
