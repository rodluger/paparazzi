...
% \begin{figure}[p!]
%     \begin{centering}
%     \includegraphics[width=0.49\linewidth]{../scratch/learn_map_high_snr_timeseries.pdf}
%     \includegraphics[width=0.49\linewidth]{../scratch/learn_map_high_snr_rect.pdf}
%     \oscaption{vogtstar}{%
%         Stuff
%         \label{fig:vogtstar}
%     }
