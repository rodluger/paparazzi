...
uncertainties.
\xxx{%
\textbf{Mention the following things:}
Advantages of data-driven modeling $\cdot$ %
Interpretable priors $\cdot$ %
Works on blended lines $\cdot$ %
Uses the whole spectrum $\cdot$ %
Yields uncertainties! $\cdot$ %
Probably works on slow rotators $\cdot$ %
Differentiable! $\cdot$ %
Fast! $\cdot$ %
Use in MCMC to marginalize over inclination and stuff
}
%
...
\end{figure}
%
\xxx{Figure~\ref{fig:twospec} shows...}

\section{Discussion}
\label{sec:discussion}
%
\subsection{Scaling of the computations}
\label{sec:scaling}
%
...
takes $\mathcal{O}(W K \lmax^2)$ operations. \xxx{More on this.}
...
\end{figure}
%
\xxx{Figure~\ref{fig:inclinations} shows...}

\subsection{Miscellaneous}
\label{sec:misc}
\xxx{%
\begin{enumerate}
\item In a more realistic scenario, we'd know more info about the spectrum.
...
\item Instrumental profile is another Toeplitz matrix.
\end{enumerate}
}

\section{Conclusions}
\label{sec:conclusions}
\xxx{Conclusions here.}
