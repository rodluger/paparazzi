...
to the \Python scripts that generated them. These figures were auto-generated
using the 
\href{https://dev.azure.com/rodluger/paparazzi/_build}{Azure Pipelines}
continuous integration (CI) service, and
icons next to each caption \figtimebox{XXmYYs} indicate the runtime
for each figure. The total runtime for the generation of this paper is
displayed above, at the end of the abstract.
