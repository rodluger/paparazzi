...
either be imposed or learned from the data. \citet{Luger2019} showed
how limb darkening can be expressed as a linear operation


\subsection{Multiple spectra}
Hello, Figure~\ref{fig:twospec}

\begin{figure}[p!]
    \begin{centering}
    \includegraphics[width=0.8\linewidth]{figures/twospec.pdf}
    \oscaption{twospec}{%
