...
% \begin{figure}[p!]
%     \begin{centering}
%         \includegraphics[width=0.49\linewidth]{spot_y1_timeseries.pdf}
%         \includegraphics[width=0.49\linewidth]{spot_y1_rect.pdf}
%         \caption{%
...
%             The rectangular projection of the original map is shown at the top right; the inferred map is displayed below it. 
%             The bottom panel shows the posterior uncertainty as a function of latitude and longitude, ranging from close to zero in the northern hemisphere to $\sigma_\mathrm{prior} \approx 10\%$ below a latitude of $-30^\circ$. 
...
The results are shown in Figure~\ref{fig:spot_y1}. 
...
This is captured by the uncertainty, which increases south of $+30^\circ$ latitude, reaching a maximum at $-30^\circ$, below which the uncertainty is constant at about 10\%. 
...
The particular value of the uncertainty in this region---10\%---is the uncertainty associated with the prior, which can be computed by replacing $\boldsymbol{\Sigma}_\bvec{\hat{y}_1}$ with $\boldsymbol{\Lambda}_\bvec{y_1}$ in Equation~(\ref{eq:spotstar:uncert}).
...
% \begin{figure}[p!]
%     \begin{centering}
%         \includegraphics[width=0.49\linewidth]{spot_y1b_timeseries.pdf.pdf}
%         \includegraphics[width=0.49\linewidth]{spot_y1b_rect.pdf}
%         \\[0.5em]
%         \includegraphics[width=0.405\linewidth]{spot_y1b_baseline.pdf}
%         \includegraphics[width=0.575\linewidth]{spot_y1b_coeffs.pdf}
%         \caption{%
...
This is due to a fundamental degeneracy involving the $Y_{1,-1}$ (\raisebox{-0.2em}{\includegraphics[width=1em]{Y1m1.pdf}}) spherical harmonic coefficient, which, because a large portion of the southern hemisphere is never in view, cannot be constrained by the data. 
...
% \begin{figure}[p!]
%     \begin{centering}
%         \includegraphics[width=0.49\linewidth]{spot_y1bs_timeseries.pdf}
%         \includegraphics[width=0.49\linewidth]{spot_y1bs_rect.pdf}
%         \\[0.5em]
%         \includegraphics[width=0.405\linewidth]{spot_y1bs_baseline.pdf}
%         \includegraphics[width=0.575\linewidth]{spot_y1bs_coeffs.pdf}
%         \\[0.5em]
%         \includegraphics[width=0.98\linewidth]{spot_y1bs_spectrum.pdf}
%         \caption{%
...
% \begin{figure}[p!]
%     \begin{centering}
%         \includegraphics[width=0.49\linewidth]{spot_y1bs_low_snr_timeseries.pdf}
%         \includegraphics[width=0.49\linewidth]{spot_y1bs_low_snr_rect.pdf}
%         \\[0.5em]
%         \includegraphics[width=0.405\linewidth]{spot_y1bs_low_snr_baseline.pdf}
%         \includegraphics[width=0.575\linewidth]{spot_y1bs_low_snr_coeffs.pdf}
%         \\[0.5em]
%         \includegraphics[width=0.98\linewidth]{spot_y1bs_low_snr_spectrum.pdf}
%         \caption{%
...
We note that we can very crudely approximate the rest frame spectrum by deconvolving the average observed spectrum with the first term of the convolution kernel $\kT$ (\raisebox{-0.1em}{\includegraphics[width=2em]{kT00.pdf}}).
...
% \begin{figure}[t!]
%     \begin{centering}
%         \includegraphics[width=\linewidth]{twospec.pdf}
%         \caption{%
...
This is due to the fact that the only information about $\bvec{s_1}$ that makes it into our dataset is the convolution of $\bvec{s_1}$ with the first term of the convolution kernel $\kT$ (\raisebox{-0.1em}{\includegraphics[width=2em]{kT00.pdf}}), since this spectral component has no spatial variability.
...
% \begin{figure}[p!]
%     \begin{centering}
%         \includegraphics[width=0.98\linewidth]{snr.pdf}
%         \caption{%
...
% \begin{figure}[p!]
%     \begin{centering}
%         \includegraphics[width=0.98\linewidth]{inclinations.pdf} % 
%         \caption{%
