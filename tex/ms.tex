...
$\lnlam = \lnlam_0 + \D$. The convolution with the delta function
has the effect of shifting the spectrum by an amount $\D$
...
\begin{figure}[p!]
    ...
    \oscaption{linalg}{%
        The Doppler design matrix, constructed from a grid of Toeplitz
