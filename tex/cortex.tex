...
\newtcbox{\figtimebox}{enhanced,nobeforeafter,tcbox raise=-0.8mm,boxrule=0.6pt,
  top=0.5mm,bottom=0mm,right=0mm,left=4mm,arc=1pt,boxsep=2pt,
  ...
  rectangle node[text=white,font=\sffamily\bfseries\tiny,rotate=0]{CI} 
  ([xshift=4mm]frame.north west);\end{tcbclipinterior}}}
\robustify{\figtimebox}
\pdfstringdefDisableCommands{%
  \def\figtimebox#1{'#1'}%
}
\newcommand{\figtime}[1]{\IfFileExists{figures/#1.figtime}%
{%
\cilink{\figtimebox{\input{figures/#1.figtime}}}
}{}}
